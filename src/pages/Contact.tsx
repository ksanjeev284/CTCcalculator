      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <div className="flex items-center mb-6">
            <Mail className="h-8 w-8 text-indigo-600 mr-3" aria-hidden="true" />
          ...
          <div className="space-y-8">
            <section aria-labelledby="get-in-touch">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h2 id="get-in-touch" className="text-xl font-semibold text-gray-800">Get in Touch</h2>
              </div>
              ...
              <a
                ...
                aria-label="Send email to ksanjeev284@gmail.com"
              >
            ...
            <section aria-labelledby="tech-issues" className="bg-gray-50 rounded-lg p-6">
              <div className="flex items-center space-x-3 mb-4">
                <AlertCircle className="h-6 w-6 text-gray-600" aria-hidden="true" />
                <h2 id="tech-issues" className="text-xl font-semibold text-gray-800">Report Technical Issues</h2>
              </div>
              
              <p className="text-gray-600 mb-4">When reporting technical issues, please include:</p>
              
              <ul className="list-disc pl-5 text-gray-600 space-y-2 mb-6" role="list">
